...
A documentation-first product project for a deeply personalized mathematics learning experience aligned initially to the Bulgarian education system for grades 4–8.

The learner interacts through a simple chat interface. The teaching agent can render interactive mathematical widgets, visual demonstrations, questions, diagnostic checks, exams, and short animated explanations directly inside the conversation.
...
2. **Simplification** — the system reduces mathematics to the smallest meaningful next action without reducing mathematical truth.
...
| Document | Purpose |
|---|---|
| [Product Vision](docs/00-PRODUCT-VISION.md) | Full product vision and highest-level architecture |
...
| [Chat and Widgets](docs/05-CHAT-AND-WIDGET-LEARNING.md) | Learning entirely through conversation and rendered UI |
